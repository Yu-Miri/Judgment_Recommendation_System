...
# Read the dataset
nli_dataset_path = 'dataset/train/KorNLI'
sts_dataset_path = 'dataset/train/KorSTS'
...
#custom dataset의 코사인 유사도 labeling 작업
df1 = pd.read_csv('dataset/train_data/custom_sts_dataset_v1.csv')
df2 = pd.read_csv('dataset/train_data/custom_sts_dataset_v2.csv')
...
sts_dataset_path = 'dataset/train_data/KorSTS'
